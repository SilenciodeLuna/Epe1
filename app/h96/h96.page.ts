...
@Component({
  selector: 'app-h96',
  templateUrl: './h96.page.html',
  styleUrls: ['./h96.page.scss'],
})
export class H96Page implements OnInit{
  ...
  async calcularPromedio(){
    ...
    let totalevas = (eva1 + eva2 + eva3) / 3;
    let pr = (epe1 * 0.1 + epe2 * 0.2 + epe3 * 0.3 + totalevas * 0.4);
    let prom = pr / 10;
